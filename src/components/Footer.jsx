...
export default function Footer() {
    ...
    useEffect(() => {
        if (messageSent) {
            ...
            const timeout = setTimeout(() => {
                ...
                setMessageSent(false); // Reset messageSent after hiding the message
            }, 2000);
    ...
    const handleMessageSend = () => {
        ...
        // For demonstration, we'll just set messageSent to true
        setMessageSent(true);
    };
    ...
    return (
        <>
            <footer className="bg-gray-800 text-white py-8 px-4 sm:px-6 lg:px-8 mt-10">
                <div className="max-w-7xl mx-auto flex justify-around footer-container">
